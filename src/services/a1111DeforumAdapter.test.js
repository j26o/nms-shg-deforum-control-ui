...
describe('a1111 deforum adapter', () => {
  it('translates the reviewed preset into Deforum settings', () => {
    ...
    expect(settings.strength).toBe(0.18);
    expect(settings.strength_schedule).toBe('0: (0.18)');
    expect(settings.noise_schedule).toBe('0: (0.04)');
    expect(settings.image_strength_schedule).toBe('0: (0.96)');
    expect(settings.tweening_frames_schedule).toBe('0: (42)');
