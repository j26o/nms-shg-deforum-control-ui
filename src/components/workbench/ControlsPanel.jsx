...
const controlDescriptions = {
  ...
  sourceStrength: 'Controls the guided-image blend amount at each keyframe. Moderate values create a slower morph; very high values can snap too quickly to the next image.',
  denoise: 'Controls Deforum img2img redraw strength for guided images. Lower values preserve the supplied frames and reduce invented geometry.',
  imageDecay: 'Controls the guided-image blend curve through each transition. Higher values create a wider slow morph toward the next node.',
  transitionFrames: 'Controls how many frames Deforum spends tweening after each image keyframe. Keep it just under the frame spacing between nodes for a slow node-to-node morph.',
