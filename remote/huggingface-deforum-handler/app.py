...
def public_job(job: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "artifactKind": job.get("artifactKind", ""),
        "isFallbackMorph": job.get("isFallbackMorph", False),
...
def run_job(job_id: str, payload: dict[str, Any]) -> None:
    ...
    try:
        ...
        update_job(
            ...
            renderMode="fallback-morph" if warnings else "a1111-deforum",
            artifactKind="fallback-morph" if warnings else "deforum-mp4",
            isFallbackMorph=bool(warnings),
